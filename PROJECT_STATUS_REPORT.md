...
> 2026-09-21 시가총액 갱신: 최신 평형 마스터 511개 단지·3,435개 타입과 KB 가격을 다시 반영했습니다. KB 시세만 385개 단지(약 165.09조원), 보정 추정 포함 421개 단지(약 194.49조원)입니다. 해운대두산위브더제니스는 KB 미고시를 검증된 최근 실거래 평형가격으로 구분 보정해 약 34,731.75억원, 남천자이는 KB 부분합계와 펜트하우스 면적단가 보정을 합산해 약 13,863.30억원으로 표시합니다. 전체 테스트 140개를 통과했습니다.
